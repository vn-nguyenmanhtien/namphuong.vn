import { IconBars3, IconBookBookmark, IconGlobe, IconLock, IconStar, IconTicket } from "@/components/icons";
  ...
  return (
    <div className="flex flex-col shadow-md rounded-b-md relative group">
      ...
      <div className="flex-1 p-4 sm:p-5">
        {/* Location */}
          {item?.locations && <div className="flex items-center mb-2">
          <IconBookBookmark className="w-4 h-4 fill-text1" />
